...
class MainGui(Ui_MainWindow):
    def __init__(self,Dialog):
        ...
        self.l1.addWidget(pw)
        pw2 = pg.PlotWidget(name='Plot2')
        self.l2.addWidget(pw2)


        pw3 = pg.PlotWidget()

        self.l3.addWidget(pw3)
    ...
    def initDate(self):
        ...
        Rrj1 = config["Rrj1"]
        Rrj2 = config["Rrj2"]
        self.Rrj1_zb = [int(Rrj1.getfloat("x")), int(Rrj1.getfloat("y")), int(Rrj1.getfloat("w")), int(Rrj1.getfloat("h"))]
        self.Rrj2_zb = [int(Rrj2.getfloat("x")), int(Rrj2.getfloat("y")), int(Rrj2.getfloat("w")), int(Rrj2.getfloat("h"))]
